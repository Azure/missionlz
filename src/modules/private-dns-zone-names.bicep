...
var privateDnsZoneNames = union([
  ...
  'privatelink.azurewebsites.${privateDnsZoneSuffixes_AzureWebSites[?environment().name] ?? cloudSuffix}' // Web Apps & Function Apps
  'scm.privatelink.azurewebsites.${privateDnsZoneSuffixes_AzureWebSites[?environment().name] ?? cloudSuffix}' // Web Apps & Function Apps
  'privatelink.wvd.${privateDnsZoneSuffixes_AzureVirtualDesktop[?environment().name] ?? cloudSuffix}' // Azure Virtual Desktop (Connection & Feed)
  'privatelink-global.wvd.${privateDnsZoneSuffixes_AzureVirtualDesktop[?environment().name] ?? cloudSuffix}' // Azure Virtual Desktop (Global)
  ...
  'privatelink.monitor.azure.${privateDnsZoneSuffixes_Monitor[?environment().name] ?? cloudSuffix}' // Azure Monitor
  'privatelink.ods.opinsights.azure.${privateDnsZoneSuffixes_Monitor[?environment().name] ?? cloudSuffix}' // Azure Monitor
  'privatelink.oms.opinsights.azure.${privateDnsZoneSuffixes_Monitor[?environment().name] ?? cloudSuffix}' // Azure Monitor
