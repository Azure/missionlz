...
echo ""
echo "To delete all resources created by this deployment try this command:"
echo "az group list --tag DeploymentName=${mlz_env_name} --query [].name -o tsv | xargs -otl az group delete -y -n"
echo ""
echo "To delete the service principal created by this deployment try this command:"
echo "az ad sp delete --id http://${mlz_sp_name}"
echo ""
echo "To delete the files generated by this deployment try this command:"
echo "rm -f ${mlz_config_file} && rm -f ${tfvars_path}"
