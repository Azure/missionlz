...
This folder contains the Bicep template for deploying Mission Landing Zone. See the [Deployment Guide](..\docs\deployment-guide-bicep.md) for Bicep for detailed instructions on how to use the template.
