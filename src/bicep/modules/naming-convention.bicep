...
var names = {
  ...
  virtualMachineDisk: replace(namingConvention_Service, tokens.resource, resourceAbbreviations.disks)
  virtualMachineNetworkInterface: replace(namingConvention_Service, tokens.resource, resourceAbbreviations.networkInterfaces)
